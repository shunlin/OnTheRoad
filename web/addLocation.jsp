...
<div id="main">
    <form class="form-horizontal" action="editLocation.do" method="post" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input name="name" type="text" class="form-control" id="locationName">
            </div>
        </div>
        <div class="form-group">
            <label for="locationState" class="col-sm-3 control-label" >Location State</label>
            <div class="col-sm-8">
                <input name="state" type="text" class="form-control" id="locationState">
            </div>
        </div>
        <div class="form-group">
            <label for="locationCountry" class="col-sm-3 control-label">Location Country</label>
            <div class="col-sm-8">
                <input name="country" type="text" class="form-control" id="locationCountry">
            </div>
        </div>
        <div class="form-group">
            <label for="locationDescription" class="col-sm-3 control-label">Location Description</label>
            <div class="col-sm-8">
                <textarea name="placeIntro" class="form-control" rows="8" id="locationDescription"></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="locationImage" class="col-sm-3 control-label">Location Image</label>
            <div class="col-sm-8">
