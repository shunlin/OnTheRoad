...
<%
    ...
    int pageNumber = Integer.parseInt(request.getParameter("nlp"));
    List<Location> locations = ld.newLocationList(pageNumber, 5);
    String pageButtonURL = "pageButtons.jsp?pageNumber=" + pageNumber + "&tableName=Location&pageName=nlp";
%>
<div id="main">
    <p class="sndTitle">Latest Locations</p>
    <%
